        ...
        {homeData.spotLightAnimes.map((anime) => (
          <SwiperSlide key={anime.id}>
            ...
            <div className="z-1 w-600 h-full absolute flex flex-col justify-end text-yellow-400 left-8 bottom-8 pb-12 md:w-1/2 lg:w-full lg:pr-100 md:left-10 md:pr-10">
              ...
              <h1 className="font-ubuntu pb-5 text-white tracking-wide mb-20 text-5xl md:text-3xl md:leading-tight md:line-clamp-2 lg:line-clamp-2 md:mb-5 md:text-2xl lg:text-2xl lg:mb-0 md:leading-5 lg:leading-5 md:tracking-tight md:mb-0 lg:mb-0">
                {anime.name}
              </h1>
              <div className="flex text-sm pb-5 items-center md:gap-1 md:font-base md:items-center md:mb-0 md:flex md:text-base lg:flex lg:text-base lg:gap-1 lg:items-center lg:mb-0">
                ...
                <span className="inline-block px-2 py-1 bg-yellow-400 text-black rounded font-semibold text-xs">
                  {anime.extra.quality}
                </span>
              </div>
              <div className="truncate border-2 border-red-500 pb-10 mr-10 font-poppins text-white text-base md:line-clamp-2 md:leading-tight md:my-0 md:text-sm lg:text-base lg:leading-tight lg:my-0 lg:text-sm xl:line-clamp-4 xl:leading-tight xl:my-0 xl:text-base">
                {anime.description}
              </div>
              <div className="flex mt-5 items-center gap-4 md:gap-1 md:flex-wrap">
                <Link
                  href={`${process.env.NEXT_PUBLIC_CLIENT}/anime/${anime.id}`} /// in future it need to UPDATE
                ...
                <Link
                  href={`${process.env.NEXT_PUBLIC_CLIENT}/anime/${anime.id}`}
