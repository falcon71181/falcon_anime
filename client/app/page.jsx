        ...
        {homeData.spotLightAnimes.map((anime) => (
          <SwiperSlide key={anime.id}>
            ...
            <div className="z-1 w-600 h-full absolute flex flex-col justify-end text-yellow-400 left-8 bottom-8 pb-12 md:w-1/2 lg:w-full lg:pr-100 md:left-10 md:pr-10">
              ...
              <div className="line-clamp-3 h-10 pb-10 mr-10 font-poppins text-white text-lg md:line-clamp-2 md:leading-tight md:my-0 md:text-sm lg:text-base lg:leading-tight lg:my-0 lg:text-sm xl:line-clamp-4 xl:leading-tight xl:my-0 xl:text-base">
                {anime.description}
              </div>
