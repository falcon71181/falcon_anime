...
const Navbar = () => {
  ...
  return (
    <div className="absolute w-full flex justify-between items-center px-3 py-6">
      <Link href="/">
        <h1 className="uppercase font-bold text-2xl text-saffron">
          F x Ani-Watch
        </h1>
      </Link>
      ...
      <ul className="flex items-center gap-7">
        ...
        <li>
          <Link
            href="/movie"
            className={`${
              pathname === "/movie" ? "text-grny" : "text-stone-300"
            } 
                            hover:text-saffron`}
          >
            Movie
        ...
        <li>
          <Link
            href="/genre"
            className={`${
              pathname === "/genre" ? "text-grny" : "text-stone-300"
            } 
                            hover:text-saffron`}
          >
            Genre
        ...
        {isValidSession ? (
            ...
            <Dropdown menu={{ items }}>
              <a onClick={(e) => e.preventDefault()}>
                <Space>
                  ...
                  href="/profile"
                  className={`${
                    pathname === "/profile" ? "text-grny" : "text-White"
                  } 
                            text-bold hover:text-saffron`}>
                  MyProfile
                  </Link>
                  <DownOutlined />
                </Space>
          ...
          <li>
            <Link href="/login">
              ...
              >
                <i className="login_animation text-bold"></i>Login / Register
                <i className="login_animation"></i>
              </button>
            </Link>
          </li>
        )}
